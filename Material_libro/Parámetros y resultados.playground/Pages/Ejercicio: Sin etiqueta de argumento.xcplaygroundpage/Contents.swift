...
## Ejercicio: Sin etiqueta de argumento
 ...
 La siguiente función tiene una etiqueta de argumento innecesaria. Elimina la etiqueta de modo que la función sea más fácil de leer cuando se la llama. Observa que igualmente necesitas el nombre del parámetro para que se ejecute el código de la función.
 */
