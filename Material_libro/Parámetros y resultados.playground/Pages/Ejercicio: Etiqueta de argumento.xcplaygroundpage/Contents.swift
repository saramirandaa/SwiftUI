...
/*:
 - callout(Ejercicio): Agrega una etiqueta de argumento a la definición de la función de modo que se lea de la siguiente manera cuando la llames:\
 `let finalScore = score(withReds: 5, greens: 3, golds: 3)`\
 No deberías tener que cambiar el código dentro de la función.
 */

/*:
[Anterior](@previous)  |  página 17 de 18  |  [Siguiente: Ejercicio: Sin etiqueta de argumento](@next)
 */