...
choice = .burger
//:  - callout(Experimento): Practica asignar otros valores a `choice` (opción) utilizando notaciones de punto más cortas. Observa que el menú emergente de completado automático aparece una vez que escribes el punto.
