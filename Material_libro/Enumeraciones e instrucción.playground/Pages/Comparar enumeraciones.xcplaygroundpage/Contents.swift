...
//:  Puedes comparar valores de `enum` utilizando ==, al igual que los valores de los tipos `String` (cadena) e `Int` (entero):
...
/*:
 - callout(Ejercicio): Cambia `myLunch` (mi almuerzo) por otra opción para ver un valor distinto en la barra lateral de resultados.
