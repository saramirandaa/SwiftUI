...
## Varios elementos “case”
 ...
 En la página anterior, usaste un elemento “case” `default` (predeterminado) para hacer coincidir tres de los valores que hay en esta enum:
 */
enum Quality {
...
/*:
 ...
 En su lugar, puedes hacer coincidir varios valores en el mismo elemento “case”:
 */
switch quality {
case .bad:
...
/*:
 - callout(Ejercicio): Agrega el elemento “case” `terrible` a la enum.
