...
/*:
 ...
 - callout(Ejercicio): Actualiza la línea especificada anteriormente con el error para que la variable pueda actualizarse. ¿Cómo escribes un tipo `String` (cadena) en vez de un tipo `Int` (entero)?
