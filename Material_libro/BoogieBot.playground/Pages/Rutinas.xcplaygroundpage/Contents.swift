...
//:  Cuando hayas decidido los movimientos que formarán la rutina, inicia el baile del robot llamando a la función que acabas de crear:
startBot()
fabulize()
doTheDisco()
doTheDisco()
...
- Si una función se modifica, los cambios se aplican en todas las instancias donde se use esa función.
 ...
 - callout(Experimento): Para este experimento, debes convertir la función `doTheDisco()` en una imagen reflejada para que cada paso escrito hacia la “izquierda” cambie a la “derecha”, y todo lo escrito hacia la “derecha” cambie a la “izquierda”. Imagina el trabajo que te habría llevado tener que escribir tres veces los mismos movimientos.
