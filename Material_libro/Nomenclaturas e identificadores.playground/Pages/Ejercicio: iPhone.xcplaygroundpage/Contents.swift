...
## Ejercicio: ¿Cuánto cabe en tu iPhone?
 ...
 En este ejercicio, descubrirás la respuesta a una pregunta habitual: ¿cuánto cabe en mi iPhone?
...
- **Un minuto** de video ocupa **150 MB** de almacenamiento.
 ...
 - callout(Ejercicio): ¿Cuántos minutos de video ocuparían toda la capacidad del teléfono?\
