...
## Trabajar con variables
 ...
 Las variables se utilizan en lugares donde un valor de tu programa debe cambiar en el tiempo. Un ejemplo es el puntaje de un juego. A medida que el jugador obtiene más puntos, el código debe actualizar el valor de una variable que lleva la cuenta del puntaje.
...
score = score + 5
/*:
Puede parecer extraño y cíclico configurar un valor como igual a sí mismo sumado a otro, como si estuvieras estableciendo un valor y también cambiándolo en un mismo paso, pero no es exactamente eso lo que sucede. Si bien es una sola línea de código, Swift evalúa la instrucción en dos pasos diferentes.
...
score = score + 3
/*:
 - callout(Experimento): ¿Cuál crees que será el valor de `score` (puntaje) después de estas líneas? ¡Prueba y descúbrelo!
