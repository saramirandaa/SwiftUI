...
- La función tiene un efecto secundario (el nombre se imprime en la consola) que no se deduce claramente a partir del nombre. Si una función tiene un efecto secundario, debe tener un verbo en el nombre.
...
/*:
 ...
 - callout(Experimento): Piensa en otras tareas que podría realizar un programa. Escríbelas como oraciones y luego piensa cómo se verían esas oraciones como funciones.\
...
[Anterior](@previous)  |  página 11 de 18  |  [Siguiente: Nombres de parámetros y etiquetas de argumento](@next)
 */