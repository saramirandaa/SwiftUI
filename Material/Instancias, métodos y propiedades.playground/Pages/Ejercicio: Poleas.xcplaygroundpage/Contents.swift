...
/*:
 - callout(Ejercicio): 
 A continuación, ya está creada la polea para subir objetos livianos. Pero tú quieres subir objetos grandes, como un caballo pequeño o un piano, por lo que instalaste una segunda polea con una canasta mucho más grande.\
...
/*:
[Anterior](@previous)  |  página 16 de 17  |  [Siguiente: Ejercicio: Identidad](@next)
 */