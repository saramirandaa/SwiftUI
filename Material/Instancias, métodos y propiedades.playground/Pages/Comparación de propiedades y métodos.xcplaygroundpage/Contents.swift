...
### Efectos secundarios
 ...
 Si el trabajo tiene _efectos secundarios_ (comportamientos que no están relacionados con el valor de devolución), es un método. Por ejemplo, el tipo `String` (cadena) tiene el método `removeAll()` (quitar todo), que vacía la cadena:
 */
