...
## Resumen
 ...
 En este playground, aprendiste cómo usar una versión más flexible de la API de visualización para crear tres tipos de visualizaciones de datos. Se trata de una API bastante flexible que puedes usar para mostrar datos en varios formatos.
