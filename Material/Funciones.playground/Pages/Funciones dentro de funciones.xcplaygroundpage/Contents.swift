...
//:  - callout(Ejercicio): Escribe una función para una segunda estrofa alternativa de la canción usando la función del submarino que se ríe a continuación.
func laughingSubmarine() {
    print("¡Ja, ja! Los engañé")
    print("Soy un submarino")
}

// Escribe la función de la segunda estrofa a continuación

/*:
En la página siguiente, aprenderás cómo las cosas pueden salir mal al usar funciones de funciones.
