...
rowTheBoat()
//:  - callout(Ejercicio): Escribe una función llamada `crocodileScream()` (grito de cocodrilo) para las dos segundas líneas de la segunda estrofa y llámala para completar la canción en la consola.
