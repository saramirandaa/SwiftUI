...
## Meme personal
 ...
 Copia las funciones que creaste en el ejercicio anterior en esta página o vuelve a escribirlas para practicar. También puedes crear un conjunto nuevo.

 Dentro de una de las funciones, introduce cambios para que el texto cambie de significado o sea más gracioso. Podrías cambiar uno de los nombres por el tuyo o el de un amigo, cambiar una palabra para generar una rima o simplemente probar lo que se te ocurra.
 */
