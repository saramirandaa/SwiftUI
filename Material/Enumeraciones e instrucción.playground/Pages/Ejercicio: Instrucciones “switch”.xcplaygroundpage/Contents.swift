...
//:  - callout(Ejercicio): Cambia la función `score(target:)` (puntaje[objetivo:]) para usar una instrucción “switch” y que devuelva el puntaje correcto de cada objetivo. En las instrucciones que aparecen a continuación, se indican los valores a los que debes apuntar:
