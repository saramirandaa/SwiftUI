...
## Ejercicio: Contar votos
 ...
 En el playground Arreglos y ciclos, tuviste la oportunidad de crear una función para contar los votos de tus compañeros. En ese momento, solo podías hacer preguntas que tuvieran como respuesta “sí” o “no” y que pudieran contenerse en resultados booleanos.
...
/*:
 - callout(Ejercicio): 
 Sin contar con los dedos, determina qué opción ganó.
 */
/*:
 - callout(Experimento): 
