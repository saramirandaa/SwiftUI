...
## Resumen
 ...
 En este playground, aprendiste a visualizar datos en tres formas diferentes. Los gráficos de pastel te permiten visualizar la conexión que hay entre cada elemento y la totalidad. Los gráficos de barras te permiten comparar con facilidad diferentes elementos de los datos. Los diagramas son útiles para visualizar la relación, o la correlación, entre dos variables diferentes. Muchas veces, se los utiliza para ilustrar cómo una variable en particular ha cambiado a lo largo del tiempo. El uso de las visualizaciones nos puede ayudar a clasificar y comparar visualmente elementos de datos para obtener nuevos conocimientos e información. Podrás hacer más con la visualización a medida que avances en el curso.
